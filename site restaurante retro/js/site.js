$(function() {
	...
	$(window).on("scroll", function(){
		var windowScroll = $(window).scrollTop();
		var windowHeight = $(window).height();
		$('#wheel img').css({'left':windowScroll - 5900,'-webkit-transform':'rotate('+windowScroll+'deg)','-moz-transform':'rotate('+windowScroll+'deg)','-o-transform':'rotate('+windowScroll+'deg)','-ms-transform':'rotate('+windowScroll+'deg)','transform':'rotate('+windowScroll+'deg)'});
	});
